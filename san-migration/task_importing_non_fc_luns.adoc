...
summary: 'FLI sólo admite LUN FC. Sin embargo, existe una solución alternativa que le permite importar LUN iSCSI. Debido a que importará los LUN iSCSI como LUN FC, a diferencia de otros flujos de trabajo FLI en línea 7-Mode a ONTAP , la ventana de interrupción abarcaría todo este flujo de trabajo:' 
---
...
[role="lead"]
FLI sólo admite LUN FC. Sin embargo, existe una solución alternativa que le permite importar LUN iSCSI. Debido a que importará los LUN iSCSI como LUN FC, a diferencia de otros flujos de trabajo FLI en línea 7-Mode a ONTAP , la ventana de interrupción abarcaría todo este flujo de trabajo:
